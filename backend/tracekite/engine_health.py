...
Stdlib and the control plane only, so an `tracekite-core` host can call it.
"""
...
def _extensions_check() -> Check:
    ...
    """
    from tracekite.parsers.parser_registry import registered_parsers
    from tracekite.services.linker.engine import registered_resolvers
