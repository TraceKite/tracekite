...
host embed it without adopting any of TraceKite's infrastructure.
...
from tracekite.services.linker import hooks
...
from tracekite.services.linker.edge_policy import finalize_edges
from tracekite.services.linker.normalize import normalize_http_calls
from tracekite.services.linker.partitions import hot_key_sizes
...
from tracekite.services.linker.registry import (                     # noqa: F401
