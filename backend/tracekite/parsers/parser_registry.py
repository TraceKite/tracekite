...
from tracekite.parsers.base import BaseParser, ParseResult
...
from tracekite.parsers.dependency_parser import parse_dependency_file
from tracekite.parsers.config_parser import parse_config_file
from tracekite.parsers.docker_parser import is_compose_filename, parse_docker_file
from tracekite.parsers.iac_parser import (
    is_kustomization_file, is_terraform_file, parse_iac_file,
)
from tracekite.parsers.kubernetes_parser import parse_k8s_file
from tracekite.parsers.mcp_manifest_parser import is_mcp_manifest, parse_mcp_manifest
from tracekite.parsers.asyncapi_parser import (
    is_asyncapi_file, is_avro_schema_file, parse_asyncapi, parse_avro_schema,
)
from tracekite.parsers.graphql_parser import (
    is_graphql_schema_file, parse_graphql_operations, parse_graphql_schema,
)
from tracekite.parsers.proto_parser import (
...
def parse_file(file_path: str, content: str) -> dict:
    ...
    if is_dependency_file(file_path):
        ...
        try:
            from tracekite.parsers.dependency_parser import parse_publish_identity
    ...
    if is_proto_file(file_name):
        ...
        try:
            from tracekite.parsers.proto_parser import parse_thrift, parse_wsdl
    ...
    try:
        from tracekite.parsers.pipeline_parser import (
    ...
    try:
        from tracekite.parsers.openapi_parser import is_openapi_file, parse_openapi
    ...
    try:
        from tracekite.parsers.cron_parser import is_cron_file, parse_crontab
