...
from tracekite.services.link_writer import list_link_runs
...
async def review_decide(body: ReviewDecision):
    ...
    from tracekite.services.control_plane import append_promotion
...
def _safe_type(edge_type: str) -> str:
    from tracekite.services.graph_writer import LINKER_EDGE_TYPES
