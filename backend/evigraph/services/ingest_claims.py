...
from evigraph.parsers.graphql_parser import DEFAULT_ROOTS, extract_gql_tags

logger = logging.getLogger(__name__)
from evigraph.services.grpc_extractor import extract_grpc_sites
...
from evigraph.services.claim_sink import add_claim  # noqa: F401 (re-export)
from evigraph.services.ingest_config_defs import (
...
def emit_source_claims(repo_id: str, file_info, content: str,
    ...
    from evigraph.services.flag_guards import annotate_flag_guards
    ...
    from evigraph.parsers.iac_units import extract_iac_services
    from evigraph.services.ingest_artifacts import process_iac_units
...
def emit_config_claims(repo_id: str, file_info, config_result, file_node_id: str,
    ...
    from evigraph.services.messaging_extractor import extract_stream_bindings
...
def emit_messaging_claims(repo_id: str, file_info, content: str,
    ...
    from evigraph.services.messaging_extractor import extract_messaging_sites
...
def emit_data_site_claims(repo_id: str, file_info, content: str,
    ...
    from evigraph.services.data_extractor import extract_data_sites
...
def emit_migration_claims(repo_id: str, file_info, content: str,
    ...
    from evigraph.parsers.migration_parser import is_migration_file, parse_migration
