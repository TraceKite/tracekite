...
host embed it without adopting any of Evigraph's infrastructure.
...
from evigraph.services.linker.edge_policy import finalize_edges
from evigraph.services.linker.normalize import normalize_http_calls
from evigraph.services.linker.partitions import hot_key_sizes
...
from evigraph.services.linker.registry import (                     # noqa: F401
