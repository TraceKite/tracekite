...
from evigraph.services.calibration_tiers import edge_tier
from evigraph.services.linker.confidence_math import wilson_interval
from evigraph.parsers.gateway_parser import parse_js_proxies, parse_nginx_conf
...
from evigraph.parsers.graphql_parser import parse_graphql_schema
...
from evigraph.services.linker.edge_policy import apply_confidence_floor
from evigraph.services.linker.engine import materialize_pending, run_resolvers
...
def _extension_estates() -> list[LabeledEstate]:
    from evigraph.services.calibration_estates import (
