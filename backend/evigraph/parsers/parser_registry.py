...
from evigraph.parsers.base import BaseParser, ParseResult
...
from evigraph.parsers.dependency_parser import parse_dependency_file
from evigraph.parsers.config_parser import parse_config_file
from evigraph.parsers.docker_parser import is_compose_filename, parse_docker_file
...
from evigraph.parsers.mcp_manifest_parser import is_mcp_manifest, parse_mcp_manifest
...
from evigraph.parsers.proto_parser import (
...
def parse_file(file_path: str, content: str) -> dict:
    ...
    if is_dependency_file(file_path):
        ...
        try:
            from evigraph.parsers.dependency_parser import parse_publish_identity
    ...
    if is_proto_file(file_name):
        ...
        try:
            from evigraph.parsers.proto_parser import parse_thrift, parse_wsdl
    ...
    try:
        from evigraph.parsers.openapi_parser import is_openapi_file, parse_openapi
    ...
    try:
        from evigraph.parsers.cron_parser import is_cron_file, parse_crontab
