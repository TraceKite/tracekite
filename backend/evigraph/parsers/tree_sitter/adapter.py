"""
Tree-sitter adapter for Evigraph.
...
from evigraph.parsers.base import (
    BaseParser,
    ParseResult,
    ParsedEntity,
    ParsedImport,
...
from evigraph.parsers.tree_sitter.core.models import (
    LanguageType,
    SymbolInfo,
...
# Map Evigraph language strings to LanguageType for callers that
...
def _get_all_source_extensions() -> set[str]:
    from evigraph.parsers.tree_sitter.core.models import LANGUAGE_METADATA
