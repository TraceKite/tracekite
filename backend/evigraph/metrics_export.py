...
evigraph-core` promises no server and no database; adding a metrics SDK to the
...
COUNTER_METRIC = "evigraph.link.counter"
TIMING_METRIC = "evigraph.link.step_seconds"
...
def open_telemetry_sink() -> tuple[MetricSink | None, str]:
    ...
    try:
        ...
        return None, ("opentelemetry is not installed; it is an optional "
                      ...
                      "metrics")
    try:
        meter = metrics.get_meter("evigraph")
