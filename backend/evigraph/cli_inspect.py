...
def cmd_history(args) -> int:
    ...
    from evigraph.services.linker.history import edge_history
    from evigraph.wire import HistoryReport
    ...
    if args.consumers_of:
        from evigraph.services.linker.history import consumers_over_time
        from evigraph.wire import ConsumerHistoryReport
...
def cmd_deprecations(args) -> int:
    ...
    from evigraph.wire import DeprecationReport
...
def cmd_suggest_aliases(args) -> int:
    ...
    from evigraph.services.linker.base import load_aliases
    from evigraph.services.linker.engine import link
...
def cmd_reverify(args) -> int:
    ...
    from evigraph.db.artifact_reader import read_claims
    from evigraph.services.evidence_reverify import downgrade_stale, reverify
...
def cmd_coverage(args) -> int:
    ...
    """
    from evigraph.services.extraction_coverage import coverage_report
...
def cmd_resolvers(args) -> int:
    ...
    """
    from evigraph.services.linker.engine import declared_order
...
def cmd_health(args) -> int:
    ...
    from evigraph.engine_health import FAILED, health
