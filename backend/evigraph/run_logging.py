...
_current_run: ContextVar[str] = ContextVar("evigraph_run_id", default="")
...
def wants_json(env: dict | None = None) -> bool:
    ...
    return env.get("EVIGRAPH_LOG_FORMAT", "").lower() == "json"
...
def configure_logging(*, json_format: bool | None = None, level: int = None,
    ...
    for existing in list(root.handlers):
        if getattr(existing, "_evigraph_configured", False):
    ...
    handler._evigraph_configured = True                          # noqa: SLF001
