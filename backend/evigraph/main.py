...
from evigraph.db.constraints import create_constraints
from evigraph.db.neo4j_client import close_driver
from evigraph.middleware.auth import BearerAuthMiddleware
from evigraph.routes import graph, health, impact, jobs, links, repos, rollup, trace
from evigraph.services.job_handlers import register_all
from evigraph.services.job_queue import job_queue, reap_stale_jobs
...
async def lifespan(app: FastAPI):
    logger.info("Starting Evigraph backend")
