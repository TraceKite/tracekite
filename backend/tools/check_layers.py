...
from layer_map import LAYERS, RANK

APP = pathlib.Path(__file__).resolve().parent.parent / "tracekite"
...
def imports_of(path: pathlib.Path) -> set[str]:
    ...
    return {m[len("tracekite."):] for m in found if m.startswith("tracekite.")}
