...
_current_run: ContextVar[str] = ContextVar("adduce_run_id", default="")
...
def wants_json(env: dict | None = None) -> bool:
    ...
    return env.get("ADDUCE_LOG_FORMAT", "").lower() == "json"
...
def configure_logging(*, json_format: bool | None = None, level: int = None,
    ...
    for existing in list(root.handlers):
        if getattr(existing, "_adduce_configured", False):
    ...
    handler._adduce_configured = True                          # noqa: SLF001
