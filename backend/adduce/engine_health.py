...
Stdlib and the control plane only, so an `adduce-core` host can call it.
"""
...
def _extensions_check() -> Check:
    ...
    """
    from adduce.parsers.parser_registry import registered_parsers
    from adduce.services.linker.engine import registered_resolvers
