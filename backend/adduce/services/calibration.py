...
from adduce.services.calibration_tiers import edge_tier
from adduce.services.linker.confidence_math import wilson_interval
from adduce.parsers.gateway_parser import parse_js_proxies, parse_nginx_conf
...
from adduce.parsers.graphql_parser import parse_graphql_schema
...
from adduce.services.linker.edge_policy import apply_confidence_floor
from adduce.services.linker.engine import materialize_pending, run_resolvers
...
def _extension_estates() -> list[LabeledEstate]:
    from adduce.services.calibration_estates import (
