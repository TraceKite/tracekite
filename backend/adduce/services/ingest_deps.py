...
from adduce.services.claim_sink import add_claim
from adduce.services.claims import CONSUMES, PROVIDES, ContractClaim, lib_key
from adduce.services.claims import is_internal_lib
from adduce.services.ingest_source import IngestSink
from adduce.services.manifest_lines import declaration_line_any
...
def _internal_namespaces() -> dict:
    ...
    if _internal_namespaces_cache is None:
        from adduce.services.linker.base import load_internal_namespaces
