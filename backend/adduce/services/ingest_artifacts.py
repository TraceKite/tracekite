...
def process_gateway(repo_id: str, file_info, rules, file_node_id: str,
    ...
    from adduce.services.ingest_claims import emit_gateway_claims
...
def process_pipeline(repo_id: str, file_info, pipeline, file_node_id: str,
    ...
    from adduce.services.ingest_claims import emit_pipeline_claims
...
def process_migration(repo_id: str, file_info, content: str,
    ...
    from adduce.services.ingest_claims import emit_migration_claims
...
def process_mcp_config(repo_id: str, file_info, sites, file_node_id: str,
                       sink: IngestSink) -> None:
    """MCP client configs."""
    from adduce.services.ingest_claims import emit_mcp_config_claims
...
def process_agent_card(repo_id: str, file_info, card, file_node_id: str,
                       sink: IngestSink) -> None:
    """A2A agent card."""
    from adduce.services.ingest_claims import emit_agent_card_claims
...
def process_codeowners(repo_id: str, file_info, rules, file_node_id: str,
    ...
    from adduce.services.ingest_claims import emit_codeowners_claims
...
def process_catalog(repo_id: str, file_info, entities, file_node_id: str,
    ...
    from adduce.services.ingest_claims import emit_catalog_claims
...
def process_observability(repo_id: str, file_info, identities,
    ...
    from adduce.services.ingest_claims import emit_observability_claims
...
def process_cron(repo_id: str, file_info, cron_calls, file_node_id: str,
    ...
    """
    from adduce.services.claims import CONSUMES, ContractClaim, http_consumes_key
    from adduce.services.ingest_claims import add_claim
...
def process_iac_units(repo_id: str, file_info, units, file_node_id: str,
    ...
    from adduce.services.ingest_claims import _SERVICE_HOST_CHARS, add_claim
    from adduce.services.redaction import redact
...
def process_openapi(repo_id: str, file_info, operations, file_node_id: str,
    ...
    """
    from adduce.services.claims import PROVIDES, ContractClaim, http_provides_key
    from adduce.services.ingest_claims import add_claim
