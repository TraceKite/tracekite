...
def _parse_chunk(job: tuple):
    ...
    from adduce.services.scan import parse_files
...
def scan_sharded(repo_path: str, repo_id: str, *, workers: int,
    ...
    from adduce.services.scan import build_structure, unfetched_submodules
    from adduce.services.sink_merge import merge_chunks
