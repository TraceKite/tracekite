...
def cmd_history(args) -> int:
    ...
    from adduce.services.linker.history import edge_history
    from adduce.wire import HistoryReport
    ...
    if args.consumers_of:
        from adduce.services.linker.history import consumers_over_time
        from adduce.wire import ConsumerHistoryReport
...
def cmd_deprecations(args) -> int:
    ...
    from adduce.wire import DeprecationReport
...
def cmd_suggest_aliases(args) -> int:
    ...
    from adduce.services.linker.base import load_aliases
    from adduce.services.linker.engine import link
...
def cmd_reverify(args) -> int:
    ...
    from adduce.db.artifact_reader import read_claims
    from adduce.services.evidence_reverify import downgrade_stale, reverify
...
def cmd_coverage(args) -> int:
    ...
    """
    from adduce.services.extraction_coverage import coverage_report
...
def cmd_resolvers(args) -> int:
    ...
    """
    from adduce.services.linker.engine import declared_order
...
def cmd_health(args) -> int:
    ...
    from adduce.engine_health import FAILED, health
