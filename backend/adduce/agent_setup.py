"""Explicit, fail-closed installation of the Adduce agent skill.
...
Use the Adduce MCP tools for cross-repository caller, dependency, and impact
questions:
...
Treat an empty or declined result as evidence that Adduce could not establish
...
TARGETS = (
    SkillTarget(frozenset({"claude"}),
                (".claude", "skills", "adduce", "SKILL.md"),
                "Claude Code"),
    SkillTarget(frozenset({"codex"}),
                (".agents", "skills", "adduce", "SKILL.md"),
                "Codex"),
    SkillTarget(frozenset({"kimi"}),
                (".kimi", "skills", "adduce", "SKILL.md"),
                "Kimi"),
    SkillTarget(frozenset({"antigravity"}),
                (".gemini", "config", "skills", "adduce", "SKILL.md"),
                "Antigravity"),
)
...
def cmd_install_skill(args) -> int:
    ...
    print("Installed or verified Adduce skill:")
