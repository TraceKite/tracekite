"""
Tree-sitter adapter for Adduce.
...
from adduce.parsers.base import (
    BaseParser,
    ParseResult,
    ParsedEntity,
    ParsedImport,
...
from adduce.parsers.tree_sitter.core.models import (
    LanguageType,
    SymbolInfo,
    get_language_by_extension,
)
from adduce.parsers.tree_sitter.core.parser import TreeSitterParser
from adduce.parsers.tree_sitter.core.extractor import TreeSitterExtractor

logger = logging.getLogger(__name__)

# Map Adduce language strings to LanguageType for callers that
...
def _get_all_source_extensions() -> set[str]:
    from adduce.parsers.tree_sitter.core.models import LANGUAGE_METADATA
