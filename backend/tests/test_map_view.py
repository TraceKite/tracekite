...
one inside the rollup handler, which meant `pip install adduce` and
...
from adduce.services.linker.map_view import assemble_service_map, node_kind
from adduce.services.linker.rollup_view import ownership_from_rows
