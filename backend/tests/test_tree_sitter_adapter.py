"""
Unit and integration tests for tracekite.parsers.tree_sitter.adapter.
...
from tracekite.parsers.tree_sitter.adapter import (
...
class TestTreeSitterAdapterErrors:
    ...
    def test_parse_failure_propagates(self, monkeypatch):
        ...
        def _failing_parse(*args, **kwargs):
            from tracekite.parsers.tree_sitter.core.models import ParsingResult
...
class TestHelperFunctions:
    ...
    def test_convert_method_call(self):
        from tracekite.parsers.tree_sitter.core.models import MethodCall
        call = MethodCall(
            caller_method="main",
