...
class TestServerDoesNotCompute:
    ...
    def test_the_server_uses_the_core_implementation(self):
        ...
        lives now."""
        from adduce.services.linker import crossings, modules

        assert crossings.module_of is modules.module_of
        import adduce.routes.links as links
...
class TestCardinality:
    ...
    def _annotated(self, edges, node_ids):
        from adduce.services.linker.base import RendezvousSpec
        from adduce.services.linker.engine import annotate_cardinality
...
class TestI4KeyDiscipline:
    ...
    def test_positional_agrees_with_the_canonicaliser(self):
        ...
        from adduce.services.linker.base import positional
