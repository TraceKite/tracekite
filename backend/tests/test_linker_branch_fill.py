...
from tracekite.services.linker import normalize
from tracekite.services.linker.normalize import normalize_http_calls
from tracekite.services.linker import r0_alias, r1_compose, r4_gateway, r7_http
...
class TestBase:
    ...
    def test_load_aliases_missing_file(self):
        ...
        with patch("tracekite.services.linker.base.os.path.exists",
                   return_value=False):
            assert load_aliases() == {}
    ...
    def test_load_aliases_translates_documented_schema(self, tmp_path):
        ...
        cfg.write_text(
            ...
            "  empty-svc:\n",
            encoding="utf-8")
        with patch("tracekite.services.linker.base.config_dir", return_value=str(tmp_path)):
...
class TestR7:
    ...
    def test_rewrite_no_matching_prefix(self):
        ...
        from tracekite.services.linker.base import RouteRule
        from tracekite.services.linker.path_algebra import resolve_chain
...
class TestRollups:
    ...
    def test_contract_service_short_id(self):
        ...
        from tracekite.services.linker import rollups as R
