...
from adduce.services.linker import r0_alias, r4_gateway, r7_http
...
class TestConfidenceControlPlane:
    ...
    def test_missing_table_fails_closed(self, tmp_path):
        from adduce.services.linker.base import ConfidenceTableMissing
        with patch("adduce.services.linker.base.config_dir",
