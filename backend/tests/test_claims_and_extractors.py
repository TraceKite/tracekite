...
from tracekite.parsers.docker_parser import parse_docker_file
from tracekite.services.http_call_extractor import extract_feign_clients, extract_http_calls
...
class TestUnrenderedTemplateNames:
    ...
    def test_helm_expressions_rejected(self):
        from tracekite.services.claims import is_unrendered_template
...
class TestComposeFileRecognition:
    ...
    def test_overlay_names_recognised(self):
        from tracekite.parsers.parser_registry import is_docker_file
...
class TestMcpManifestParser:
    ...
    def _parse(self, doc):
        import json
        from tracekite.parsers.mcp_manifest_parser import parse_mcp_manifest
    ...
    def test_recognised_by_filename(self):
        from tracekite.parsers.mcp_manifest_parser import is_mcp_manifest
