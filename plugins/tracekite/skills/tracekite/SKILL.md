...
Use the TraceKite MCP tools for cross-repository caller, dependency, and impact
questions:
...
Treat an empty or declined result as evidence that TraceKite could not establish
