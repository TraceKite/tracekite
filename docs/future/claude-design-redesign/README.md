...
editable source after the current Adduce application had been reviewed in the
...
[Open the Claude Design project](https://claude.ai/design/p/c0b40f89-5e1a-4f26-a97c-084e0ec2d535?file=Adduce+-+Graph+Investigation+Workspace.dc.html)
...
| [adduce-graph-investigation.dc.html](adduce-graph-investigation.dc.html) | Editable five-screen source artifact |
...
Then open
`http://localhost:8000/adduce-graph-investigation.dc.html`.
